  ...
  <q-page class="q-pa-md">
        ...
        >
          <template v-slot:body-cell-Ime_prodavaca="props">
            <q-td :props="props">
              ...
              <q-input
                v-else
                v-model="props.row.Ime_prodavaca"
          ...
          <template v-slot:body-cell-Adresa_prodavaca="props">
            <q-td :props="props">
              ...
              <q-input
                v-else
                v-model="props.row.Adresa_prodavaca"
          ...
          <template v-slot:body-cell-E_mail_prodavaca="props">
            <q-td :props="props">
              ...
              <q-input
                v-else
                v-model="props.row.E_mail_prodavaca"
          ...
          <template v-slot:body-cell-actions="props">
            <q-td :props="props" align="center">
              <q-btn
                ...
                icon="delete"
                color="red"
                @click="deleteSeller(props.row.Sifra_prodavaca)"
              />
            </q-td>
          </template>
        </q-table>
    ...
    <q-dialog v-model="isDialogOpen">
      <q-card>
        <q-card-section>
          <div class="text-h6">
            {{ isEditing ? "Uredi Prodavača" : "Dodaj Prodavača" }}
          </div>
        </q-card-section>
        <q-card-section>
...
const columns = [
  ...
  {
    name: "Adresa_prodavaca",
    label: "Adresa",
    field: "Adresa_prodavaca",
    align: "left",
  },
  {
    name: "E_mail_prodavaca",
    label: "Email",
    field: "E_mail_prodavaca",
    align: "left",
  },
...
const updateSeller = async () => {
  await axios.put(
    `${baseURL}/sellers/${form.value.Sifra_prodavaca}`,
    form.value
  );
  fetchSellers();
  closeDialog();
